...
%prep
%setup -q -n HTML-Form-6.07
cd %{_builddir}/HTML-Form-6.07
...
cp %{_builddir}/HTML-Form-6.07/LICENSE %{buildroot}/usr/share/package-licenses/perl-HTML-Form/309a589f389ca0257473439676541372e4128bc8
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/HTML/Form.pm
